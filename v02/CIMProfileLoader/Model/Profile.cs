...
namespace FTN.ESI.SIMES.CIM.Model
{
    ...
    public class Profile
    {
        ...
        // Dodato
        public int BrKlasa { get => brKlasa; set => brKlasa = value; }
        public int BrKom { get => brKom; set => brKom = value; }
        public int BrAtr { get => brAtr; set => brAtr = value; }
        ...
        public override string ToString()
        {
            ...
            {
                // Dodato
                toStringBuilder.Append("Broj klasa: " + BrKlasa + "\n");
                toStringBuilder.Append("Broj atributa: " + BrAtr + "\n");
                toStringBuilder.Append("Broj komentara: " + BrKom + "\n\n");
