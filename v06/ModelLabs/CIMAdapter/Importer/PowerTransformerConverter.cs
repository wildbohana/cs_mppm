namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
	...
	public static class PowerTransformerConverter
	{
        ...
        // Dodato - popunjavanje propertija za TW
        public static void PopulateTransformerWindingProperties(TransformerWinding cimTransformerWinding, ResourceDescription rd, ImportHelper importHelper, TransformAndLoadReport report)
        {
		...
		// Dodato - popunjavanje propertija za WT
        public static void PopulateWindingTestProperties(WindingTest cimWindingTest, ResourceDescription rd, ImportHelper importHelper, TransformAndLoadReport report)
        {
