...
namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
	...
	public class PowerTransformerImporter
	{
		...
		private void ConvertModelAndPopulateDelta()
		{
			...
			//// IMPORT TransformerWindings and WindingTests
		...
		private void ImportTransformerWindings()
		{
            ...
            {
                foreach (KeyValuePair<string, object> cimTransformerWindingsPair in cimTransformerWindings)
                {
                    FTN.TransformerWinding cimTransformerWinding = cimTransformerWindingsPair.Value as FTN.TransformerWinding;
        ...
        private ResourceDescription CreateWindingTestResourceDescription(WindingTest cimWindingTest)
        {
            ResourceDescription rd = null;
